...
(function () {
  ...
  var translations = {
    en: {
      ...
      workshops_heading: 'Haifa · Retreat · Events',
      ...
      events_sh_card_desc: 'Friday 17 July · 18:30 · Haifa, Atlit beach — open to everyone.',
      events_sh_meta_desc: 'Deep Sound Healing session with Nawal Omar in Haifa, Atlit beach. Friday 17 July at 18:30. Limited places.',
      ...
      events_sh_register_note: 'To register, send me a direct message',
      events_sh_register_btn: 'Register via Instagram DM',
      events_sh_register_aria: 'Register for Sound Healing via Instagram direct message',
      ...
      retreat_dahab_cv_inc7_desc: 'Eilat ↔ Dahab, included in the price.',
...
This retreat is not only a trip to a beautiful place; it is a real invitation to return to yourself: to your body, to your breath, and to the inner sea that calms when it finds the right space. Zanzibar here is not just a destination—it is a complete experience guided carefully by Nawal, with a deep feminine touch that makes each participant feel part of something living, soft, and transformative.`,
      ...
      jiva_class_power_desc:
        'Power Yoga aims to strengthen the body, build flexibility and endurance, and learn advanced poses gradually and safely.',
      jiva_class_saturday_day: 'Saturday',
      jiva_class_saturday_title: 'Calm & deep rest',
      jiva_class_saturday_desc:
        'Saturday class focuses on calming, deep breathing, and relaxing the nervous system.',
      jiva_power_photo_alt1: 'Partner boat pose — advanced Power Yoga',
      jiva_power_photo_alt2: 'Upward-facing dog with instructor guidance',
      jiva_power_photo_alt3: 'Group Power Yoga practice by the sea',
      ...
      jiva_schedule_slot1: 'Tuesday · Power Yoga · Naeem Studio · 19:20',
      jiva_schedule_slot2: 'Saturday · Calm & breath · by the sea · 18:30',
    ...
    ar: {
      ...
      workshops_heading: 'حيفا · ريتريت · فعاليات',
      ...
      events_sh_card_desc: 'الجمعة 17.7 · 18:30 · حيفا، شط عتليت — مناسبة للجميع.',
      events_sh_meta_desc: 'جلسة Sound Healing عميقة مع نوال عمر في حيفا، شط عتليت. الجمعة 17.7 الساعة 18:30. أماكن محدودة.',
      ...
      events_sh_register_note: 'للتسجيل ابعتولي رسالة مباشر',
      events_sh_register_btn: 'سجّلي عبر رسالة مباشرة',
      events_sh_register_aria: 'التسجيل لجلسة Sound Healing عبر إنستغرام',
      ...
      retreat_dahab_cv_inc7_desc: 'من إيلات إلى دهب — مشمولة بالسعر.',
...
هذا الريتريت ليس فقط رحلة إلى مكان جميل، بل دعوة حقيقية للعودة إلى الذات: إلى الجسد، إلى النفس، إلى البحر الداخلي الذي يهدأ حين يجد المساحة المناسبة. زنجبار هنا ليست مجرد وجهة - بل تجربة كاملة تقودها نوال بعناية، حضور، ولمسة أنثوية عميقة تجعل كل مشاركة تشعر أنها جزء من شيء حي، ناعم، ومتحوّل.`,
      ...
      jiva_class_power_title: 'Power Yoga',
      jiva_class_power_desc:
        'هدف حصص الـPower Yoga هو تقوية الجسم، رفع المرونة والتحمّل، وتعلّم حركات متقدمة بطريقة تدريجية وآمنة.',
      jiva_class_saturday_day: 'السبت',
      jiva_class_saturday_title: 'تهدئة وتنفّس عميق',
      jiva_class_saturday_desc:
        'حصة يوم السبت مخصّصة أكثر للتهدئة، التنفّس العميق، وإرخاء الجهاز العصبي.',
      jiva_power_photo_alt1: 'وضعية القارب الثنائية — Power Yoga متقدم',
      jiva_power_photo_alt2: 'كلب متجه للأعلى مع توجيه المدربة',
      jiva_power_photo_alt3: 'تدريب Power Yoga جماعي قبال البحر',
      ...
      jiva_schedule_slot1: 'الثلاثاء · Power Yoga · ستوديو نعيم · 19:20',
      jiva_schedule_slot2: 'السبت · تهدئة وتنفّس · قبال البحر · 18:30',
