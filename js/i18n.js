...
(function () {
  ...
  var translations = {
    en: {
      ...
      events_ib_form_subtitle: 'A short health form so we can hold the experience safely — one step at a time.',
      events_ib_draft_idle: 'Auto-save enabled',
      events_ib_draft_saved: 'Draft saved',
      events_ib_step_label: 'Step {current} of {total}',
      events_ib_step1_title: '1) Personal information',
      events_ib_step2_title: '2) Emergency contact',
      events_ib_step3_title: '3) Cold-exposure screening',
      events_ib_step4_title: '4) Additional health',
      events_ib_step5_title: '5) Notes + consent',
      events_ib_step6_title: '6) Signature',
      events_ib_full_name: 'Full name',
      events_ib_id_number: 'ID number',
      events_ib_birth_date: 'Date of birth',
      events_ib_phone: 'Phone',
      events_ib_emergency_name: 'Name',
      events_ib_relationship: 'Relationship',
      events_ib_yes: 'Yes',
      events_ib_no: 'No',
      events_ib_q_heart: 'Heart disease, high blood pressure, or circulatory issues?',
      events_ib_q_circulation: 'Raynaud’s syndrome or known sensitivity to cold?',
      events_ib_q_pregnancy: 'Are you currently pregnant?',
      events_ib_q_epilepsy: 'Epilepsy, seizures, or fainting history?',
      events_ib_q_breathing: 'Breathing issues, asthma, or dizziness?',
      events_ib_allergy: 'Allergies',
      events_ib_medications: 'Current medications',
      events_ib_other_conditions: 'Other conditions we should know about',
      events_ib_notes: 'Additional notes',
      events_ib_consent_info: 'I confirm the information above is accurate',
      events_ib_consent_cold:
        'I understand ice bath / cold exposure involves physical stress and I participate at my own responsibility',
      events_ib_consent_first_aid: 'I consent to first aid if needed',
      events_ib_consent_photos: 'I agree to photos/video during the session',
...
This retreat is not only a trip to a beautiful place; it is a real invitation to return to yourself: to your body, to your breath, and to the inner sea that calms when it finds the right space. Zanzibar here is not just a destination—it is a complete experience guided carefully by Nawal, with a deep feminine touch that makes each participant feel part of something living, soft, and transformative.`,
    ...
    ar: {
      ...
      events_ib_form_title: 'استمارة صحية — Ice Bath',
      events_ib_form_subtitle: 'استمارة صحية قصيرة لنحافظ على أمان التجربة — خطوة بخطوة.',
      events_ib_draft_idle: 'يتم الحفظ تلقائيًا',
      events_ib_draft_saved: 'تم حفظ المسودة',
      events_ib_step_label: 'الخطوة {current} من {total}',
      events_ib_step1_title: '1) المعلومات الشخصية',
      events_ib_step2_title: '2) جهة الطوارئ',
      events_ib_step3_title: '3) فحص التعرّض للبرد',
      events_ib_step4_title: '4) صحة إضافية',
      events_ib_step5_title: '5) ملاحظات + إقرار',
      events_ib_step6_title: '6) التوقيع',
      events_ib_full_name: 'الاسم الكامل',
      events_ib_id_number: 'رقم الهوية',
      events_ib_birth_date: 'تاريخ الميلاد',
      events_ib_phone: 'الهاتف',
      events_ib_emergency_name: 'الاسم',
      events_ib_relationship: 'صلة القرابة',
      events_ib_yes: 'نعم',
      events_ib_no: 'لا',
      events_ib_q_heart: 'هل لديك أمراض قلب، ضغط مرتفع، أو مشاكل في الدورة الدموية؟',
      events_ib_q_circulation: 'هل لديك متلازمة رينو أو حساسية معروفة للبرد؟',
      events_ib_q_pregnancy: 'هل أنتِ حامل حاليًا؟',
      events_ib_q_epilepsy: 'هل لديك صرع، تشنّجات، أو تاريخ إغماء؟',
      events_ib_q_breathing: 'هل لديك مشاكل تنفّس، ربو، أو دوخة؟',
      events_ib_allergy: 'حساسية',
      events_ib_medications: 'أدوية حالية',
      events_ib_other_conditions: 'حالات أخرى يجب أن نعرفها',
      events_ib_notes: 'ملاحظات إضافية',
      events_ib_consent_info: 'أقرّ بصحة المعلومات أعلاه',
      events_ib_consent_cold:
        'أفهم أن Ice Bath / التعرّض للبرد يحمل جهدًا جسديًا وأشارك على مسؤوليتي الخاصة',
      events_ib_consent_first_aid: 'أوافق على الإسعافات الأولية عند الحاجة',
      events_ib_consent_photos: 'أوافق على التصوير أثناء الجلسة',
