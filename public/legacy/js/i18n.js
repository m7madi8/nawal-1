...
(function () {
  ...
  var translations = {
    en: {
      ...
      events_sh_card_desc: 'Friday 25 September · 18:30 · Haifa, Atlit beach — open to everyone.',
      events_sh_meta_desc: 'Deep Sound Healing session with Nawal Omar in Haifa, Atlit beach. Friday 25 September at 18:30. Limited places.',
      events_sh_date: 'Friday, 25 September',
      ...
      events_sh_register_note: 'Register through the form — your request appears in our dashboard.',
      events_sh_booking_notice: 'Booking is confirmed via Bit or bank transfer.',
      events_sh_register_btn: 'Register now',
      events_sh_register_aria: 'Register for Sound Healing',
      events_sh_register_title: 'Confirm your registration',
      events_sh_register_event: 'Sound Healing · Friday 25 September · 18:30',
      events_sh_register_name: 'Full name',
      events_sh_register_phone: 'Phone (WhatsApp preferred)',
      events_sh_register_notes: 'Notes (optional)',
      events_sh_register_confirm: 'Confirm registration',
      events_sh_register_success: 'Registration sent successfully. We will contact you shortly.',
      events_sh_register_error: 'Sorry, registration failed. Please try again.',
      booking_register_note: 'Register through the form — your request appears in our dashboard.',
      booking_register_btn: 'Register now',
      booking_wa_or: 'Or contact us on WhatsApp',
      booking_wa_aria: 'Contact us on WhatsApp',
      ...
      events_nc_cta_aria: 'Book A Day Between Nature & Chocolate',
      events_nc_register_title: 'Confirm your booking',
      events_nc_register_event: 'A Day Between Nature & Chocolate · 8.8',
      events_nc_register_name: 'Full name',
      events_nc_register_phone: 'Phone (WhatsApp preferred)',
      events_nc_register_notes: 'Notes (optional)',
      events_nc_register_confirm: 'Confirm registration',
      events_nc_register_success: 'Registration sent successfully. We will contact you shortly.',
      events_nc_register_error: 'Sorry, registration failed. Please try again.',
      ...
      retreat_wadi_hero_date: 'Soon',
      retreat_wadi_hero_meta_date: 'Friday 19 September',
      retreat_wadi_hero_meta_duration: '5 days · 4 nights',
      retreat_wadi_hero_meta_place: 'Wadi Rum, Jordan',
      retreat_wadi_page_title: 'Moonlit Wadi Rum Retreat',
      retreat_wadi_page_intro: 'A journey into the depth of the soul — where the desert meets the sky.',
      retreat_wadi_page_intro2: 'Yoga, breathwork, sound healing & women’s circle under the stars.',
      ...
      zanzibar_sold_out: 'Ended',
      zanzibar_dates_soon: 'This retreat has ended — no new date is set',
      zanzibar_form_closed: 'Registration is closed. This retreat has ended.',
      ...
      retreat_wadi_inc6: '2 deep workshops + sound healing + professional photography.',
...
Yoga and sound healing retreat with a Zanzibar Island exploration.`,
      ...
      retreat_cta_title: 'This retreat has ended',
      retreat_cta_subtitle: 'Registration is closed. No new date is set.',
...
This retreat is not only a trip to a beautiful place; it is a real invitation to return to yourself: to your body, to your breath, and to the inner sea that calms when it finds the right space. Zanzibar here is not just a destination—it is a complete experience guided carefully by Nawal, with a deep feminine touch that makes each participant feel part of something living, soft, and transformative.`,
    ...
    ar: {
      ...
      events_sh_card_desc: 'الجمعة 25.9 · 18:30 · حيفا، شط عتليت — مناسبة للجميع.',
      events_sh_meta_desc: 'جلسة Sound Healing عميقة مع نوال عمر في حيفا، شط عتليت. الجمعة 25.9 الساعة 18:30. أماكن محدودة.',
      events_sh_date: 'الجمعة 25.9',
      ...
      events_sh_register_note: 'للتسجيل عبر النموذج — الطلب يصل مباشرة إلى لوحة التحكم.',
      events_sh_booking_notice: 'يتم تثبيت الحجز عن طريق Bit أو تحويلة بنكية',
      events_sh_register_btn: 'سجّل الآن',
      events_sh_register_aria: 'التسجيل لجلسة Sound Healing',
      events_sh_register_title: 'تأكيد التسجيل',
      events_sh_register_event: 'Sound Healing · الجمعة 25.9 · 18:30',
      events_sh_register_name: 'الاسم الكامل',
      events_sh_register_phone: 'رقم الهاتف (يفضّل واتساب)',
      events_sh_register_notes: 'ملاحظات (اختياري)',
      events_sh_register_confirm: 'تأكيد التسجيل',
      events_sh_register_success: 'تم إرسال التسجيل بنجاح. سنتواصل معك قريبًا.',
      events_sh_register_error: 'تعذّر إرسال التسجيل، حاولي مرة أخرى.',
      booking_register_note: 'للتسجيل عبر النموذج — الطلب يصل مباشرة إلى لوحة التحكم.',
      booking_register_btn: 'سجّل الآن',
      booking_wa_or: 'أو تواصلي معنا على واتساب',
      booking_wa_aria: 'تواصل معنا على واتساب',
      ...
      events_nc_cta_aria: 'احجزي يوم بين الطبيعة والشوكولاته',
      events_nc_register_title: 'تأكيد الحجز',
      events_nc_register_event: 'يوم بين الطبيعة والشوكولاته · 8.8',
      events_nc_register_name: 'الاسم الكامل',
      events_nc_register_phone: 'رقم الهاتف (يفضّل واتساب)',
      events_nc_register_notes: 'ملاحظات (اختياري)',
      events_nc_register_confirm: 'تأكيد التسجيل',
      events_nc_register_success: 'تم إرسال التسجيل بنجاح. سنتواصل معك قريبًا.',
      events_nc_register_error: 'تعذّر إرسال التسجيل، حاولي مرة أخرى.',
      ...
      retreat_wadi_hero_date: 'قريباً',
      retreat_wadi_hero_meta_date: 'الجمعة 19.9',
      retreat_wadi_hero_meta_duration: '5 أيام · 4 ليالي',
      retreat_wadi_hero_meta_place: 'وادي رم، الأردن',
      retreat_wadi_page_title: 'ريتريت وادي رم ضوء القمر',
      retreat_wadi_page_intro: 'رحلة إلى عمق الروح — حيث تلتقي الصحراء بالسما.',
      retreat_wadi_page_intro2: 'يوغا، تنفّس، ساوند هيلينغ ودائرة نسائية تحت النجوم.',
      ...
      zanzibar_sold_out: 'انتهى',
      zanzibar_dates_soon: 'هذا الريتريت انتهى — لا يوجد تاريخ جديد',
      zanzibar_form_closed: 'التسجيل مغلق. هذا الريتريت انتهى.',
      ...
      retreat_wadi_inc6: 'ورشتيّن عميقتين + ساوند هيلينغ + تصوير احترافي.',
...
ريتريت يوغا وساوند هيلينغ مع اكتشاف جزيرة زنجبار`,
      ...
      retreat_cta_title: 'هذا الريتريت انتهى',
      retreat_cta_subtitle: 'التسجيل مغلق. لا يوجد تاريخ جديد.',
