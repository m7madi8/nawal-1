...
const LOGO = {
  header: '/media/brand/Black White Minimalist Simple Logo.png',
  footer: '/media/brand/Black White Minimalist Simple Logo.png',
  mobile: '/media/brand/Black White Minimalist Simple Logo.png',
};
